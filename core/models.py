...
class TradingConfig:
    ...
    def __init__(
        ...
        weak_daily_entries: int = 6,
        hard_daily_entries: int = 3,
        ...
        min_signal_score_for_entry: float = 88.0,
        min_signal_score_defensive: float = 94.0,
        god_direct_score: float = 92.0,
        pre_break_direct_score: float = 88.0,
        ...
        quality_guard_min_profit_factor: float = 0.85,
        quality_guard_min_win_rate: float = 40.0,
        quality_guard_max_loss_streak: int = 3,
        quality_guard_defensive_min_score: float = 92.0,
        quality_guard_defensive_max_change_pct: float = 18.0,
        quality_guard_defensive_max_oi_pct: float = 70.0,
        ...
        momentum_entry_score: float = 88.0,
        momentum_entry_min_change_pct: float = 12.0,
        momentum_entry_min_oi_pct: float = 25.0,
        ...
        accumulation_entry_score: float = 85.0,
        ...
        capital_min_expected_rr: float = 2.50,
        ...
        capital_min_risk_pct: float = 0.3,
        capital_max_risk_pct: float = 1.0,
