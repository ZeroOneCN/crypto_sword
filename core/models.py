...
class TradingConfig:
    ...
    def __init__(
        ...
        max_total_exposure_pct: float = 250.0,
        ...
        max_chase_change_pct: float = 35.0,
        ...
        momentum_entry_score: float = 60.0,
        momentum_entry_min_change_pct: float = 10.0,
        momentum_entry_min_oi_pct: float = 24.0,
        ...
        accumulation_entry_score: float = 55.0,
        accumulation_entry_min_oi_pct: float = 8.0,
