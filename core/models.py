...
class TradingConfig:
    ...
    def __init__(
        ...
        max_chase_change_pct: float = 28.0,
        ...
        min_quote_volume_usdt: float = 500000.0,
        ...
        breakeven_offset_pct: float = 0.15,
        stop_trigger_buffer_pct: float = 0.25,
        breakout_stop_trigger_buffer_pct: float = 0.30,
        pullback_stop_trigger_buffer_pct: float = 0.18,
        ...
        momentum_entry_min_change_pct: float = 8.0,
        momentum_entry_min_oi_pct: float = 18.0,
        ma_reentry_enabled: bool = True,
        ma_reentry_score: float = 66.0,
        ma_reentry_min_change_pct: float = 4.0,
        ma_reentry_max_change_pct: float = 28.0,
        ma_reentry_min_oi_pct: float = 8.0,
        ma_reentry_min_pullback_pct: float = 0.8,
        ...
        accumulation_entry_score: float = 68.0,
        accumulation_entry_min_oi_pct: float = 12.0,
        ...
        breakout_tp_multiplier: float = 1.15,
        breakout_stop_multiplier: float = 0.75,
        pullback_tp_multiplier: float = 1.05,
        pullback_stop_multiplier: float = 0.85,
        ...
        capital_min_expected_rr: float = 1.45,
