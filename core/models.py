...
class TradingConfig:
    ...
    def __init__(
        ...
        weak_daily_entries: int = 4,
        hard_daily_entries: int = 2,
        daily_exception_entries: int = 1,
        exception_entry_score: float = 88.0,
        exception_entry_min_change_pct: float = 5.0,
        exception_entry_max_change_pct: float = 40.0,
        exception_entry_min_oi_pct: float = 12.0,
        exception_entry_max_oi_pct: float = 100.0,
        exception_entry_max_abs_funding_rate: float = 0.0040,
        defensive_score_override_score: float = 90.0,
        defensive_score_override_daily_limit: int = 2,
        defensive_score_override_max_oi_pct: float = 90.0,
        defensive_score_override_max_abs_funding_rate: float = 0.0035,
        min_signal_score_for_entry: float = 78.0,
        ...
        quality_guard_defensive_max_range_position_pct: float = 92.0,
        ...
        min_change_pct: float = 0.8,
        max_chase_change_pct: float = 30.0,
        min_pullback_pct: float = 0.8,
        shallow_pullback_pct: float = 0.6,
        reclaim_volume_ratio: float = 0.75,
        max_range_position_pct: float = 95.0,
        max_abs_funding_rate: float = 0.0050,
        ...
        oi_funding_rising_bonus: float = 6.0,
        oi_funding_bonus_cap: float = 8.0,
        oi_funding_cache_sec: int = 120,
        breakeven_after_tp: bool = True,
        breakeven_offset_pct: float = 0.8,
        tp_fill_price_tolerance_pct: float = 0.35,
        pre_tp_micro_exit_guard_enabled: bool = True,
        pre_tp_micro_exit_guard_min_roi_pct: float = 0.5,
        ...
        momentum_entry_score: float = 80.0,
        momentum_entry_min_change_pct: float = 5.0,
        momentum_entry_min_oi_pct: float = 9.0,
        ma_reentry_enabled: bool = True,
        ma_reentry_score: float = 58.0,
        ma_reentry_min_change_pct: float = 2.0,
        ma_reentry_max_change_pct: float = 32.0,
        ma_reentry_min_oi_pct: float = 4.0,
        ma_reentry_min_pullback_pct: float = 0.4,
        ma_reentry_max_pullback_pct: float = 9.0,
        ma_reentry_ma_tolerance_pct: float = 1.6,
        ma_reentry_max_extension_pct: float = 9.0,
        ma_reentry_min_volume_ratio: float = 0.60,
        accumulation_entry_enabled: bool = True,
        accumulation_entry_score: float = 74.0,
        accumulation_entry_min_oi_pct: float = 7.0,
        ...
        ai_fast_lane_enabled: bool = True,
        ai_funding_squeeze_score: float = 78.0,
        ai_funding_squeeze_min_oi_pct: float = 10.0,
        ai_funding_squeeze_min_change_pct: float = 3.0,
        ai_accumulation_direct_score: float = 76.0,
        ai_accumulation_direct_max_change_pct: float = 14.0,
        ai_watch_escalation_sec: int = 10 * 60,
        ai_watch_escalation_score: float = 82.0,
        ...
        capital_min_expected_rr: float = 1.65,
        capital_max_leverage: int = 5,
        capital_aggressive_score: float = 86.0,
        capital_defensive_drawdown_pct: float = 1.0,
        capital_hard_drawdown_pct: float = 2.2,
        capital_min_risk_pct: float = 0.25,
        capital_max_risk_pct: float = 0.8,
        ...
        self.quality_guard_min_profit_factor = max(0.0, float(quality_guard_min_profit_factor))
        self.quality_guard_min_win_rate = max(0.0, float(quality_guard_min_win_rate))
        self.quality_guard_max_loss_streak = max(1, int(quality_guard_max_loss_streak))
        self.quality_guard_defensive_min_score = max(self.min_signal_score_for_entry, float(quality_guard_defensive_min_score))
        self.quality_guard_defensive_max_change_pct = max(0.0, float(quality_guard_defensive_max_change_pct))
        self.quality_guard_defensive_max_oi_pct = max(0.0, float(quality_guard_defensive_max_oi_pct))
        self.quality_guard_defensive_max_range_position_pct = max(0.0, float(quality_guard_defensive_max_range_position_pct))
        ...
        self.ai_fast_lane_enabled = bool(ai_fast_lane_enabled)
        self.ai_funding_squeeze_score = max(0.0, float(ai_funding_squeeze_score))
        self.ai_funding_squeeze_min_oi_pct = max(0.0, float(ai_funding_squeeze_min_oi_pct))
        self.ai_funding_squeeze_min_change_pct = max(0.0, float(ai_funding_squeeze_min_change_pct))
        self.ai_accumulation_direct_score = max(0.0, float(ai_accumulation_direct_score))
        self.ai_accumulation_direct_max_change_pct = max(0.0, float(ai_accumulation_direct_max_change_pct))
        self.ai_watch_escalation_sec = max(60, int(ai_watch_escalation_sec))
        self.ai_watch_escalation_score = max(0.0, float(ai_watch_escalation_score))
