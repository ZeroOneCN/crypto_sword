...
class TradingConfig:
    ...
    def __init__(
        ...
        max_chase_change_pct: float = 20.0,
        ...
        ma_reentry_enabled: bool = False,
        ma_reentry_score: float = 78.0,
        ...
        accumulation_entry_score: float = 75.0,
        ...
        capital_min_expected_rr: float = 1.80,
