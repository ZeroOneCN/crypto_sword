...
class TradingConfig:
    ...
    def __init__(
        ...
        exception_entry_score: float = 90.0,
        ...
        exception_entry_max_abs_funding_rate: float = 0.0035,
        defensive_score_override_score: float = 92.0,
        ...
        god_direct_score: float = 92.0,
        pre_break_direct_score: float = 82.0,
        confirmed_breakout_direct_score: float = 90.0,
        confirmed_breakout_max_change_pct: float = 24.0,
        confirmed_breakout_max_range_position_pct: float = 90.0,
        ...
        quality_guard_defensive_min_score: float = 90.0,
        quality_guard_defensive_max_change_pct: float = 22.0,
        quality_guard_defensive_max_oi_pct: float = 75.0,
        quality_guard_defensive_max_range_position_pct: float = 88.0,
        ...
        max_chase_change_pct: float = 24.0,
        min_pullback_pct: float = 1.2,
        shallow_pullback_pct: float = 0.6,
        reclaim_volume_ratio: float = 0.90,
        max_range_position_pct: float = 92.0,
        max_abs_funding_rate: float = 0.0045,
        max_oi_change_pct: float = 100.0,
        ...
        momentum_entry_min_change_pct: float = 6.0,
        momentum_entry_min_oi_pct: float = 12.0,
        ma_reentry_enabled: bool = True,
        ma_reentry_score: float = 62.0,
        ma_reentry_min_change_pct: float = 2.5,
        ma_reentry_max_change_pct: float = 32.0,
        ma_reentry_min_oi_pct: float = 5.0,
        ...
        ma_reentry_min_volume_ratio: float = 0.70,
        accumulation_entry_enabled: bool = True,
        accumulation_entry_score: float = 78.0,
        accumulation_entry_min_oi_pct: float = 10.0,
        accumulation_entry_max_change_pct: float = 16.0,
        accumulation_entry_max_range_pct: float = 82.0,
        accumulation_entry_min_volume_mult: float = 0.85,
        ...
        capital_aggressive_score: float = 88.0,
