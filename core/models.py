...
class TradingConfig:
    ...
    def __init__(
        ...
        min_total_exposure_pct: float = 45.0,
        dynamic_total_exposure_hard_cap_pct: float = 120.0,
        max_daily_loss_pct: float = 5.0,
        max_open_positions: int = 3,
        daily_entry_limit_enabled: bool = True,
        ...
        defensive_score_override_max_abs_funding_rate: float = 0.0025,
        min_signal_score_for_entry: float = 90.0,
        min_signal_score_defensive: float = 95.0,
        god_direct_score: float = 95.0,
        pre_break_direct_score: float = 90.0,
        confirmed_breakout_direct_score: float = 98.0,
        confirmed_breakout_max_change_pct: float = 18.0,
        confirmed_breakout_max_range_position_pct: float = 85.0,
        ...
        quality_guard_defensive_min_score: float = 95.0,
        quality_guard_defensive_max_change_pct: float = 16.0,
        quality_guard_defensive_max_oi_pct: float = 60.0,
        quality_guard_defensive_max_range_position_pct: float = 82.0,
        ...
        shallow_pullback_pct: float = 1.0,
        reclaim_volume_ratio: float = 1.15,
        max_range_position_pct: float = 88.0,
        max_abs_funding_rate: float = 0.0035,
        max_oi_change_pct: float = 80.0,
        max_entry_slippage_pct: float = 0.30,
        ...
        momentum_entry_score: float = 92.0,
        ...
        accumulation_entry_score: float = 88.0,
        accumulation_entry_min_oi_pct: float = 16.0,
        accumulation_entry_max_change_pct: float = 12.0,
        accumulation_entry_max_range_pct: float = 75.0,
        accumulation_entry_min_volume_mult: float = 1.10,
        ...
        capital_min_expected_rr: float = 2.30,
