...
def main():
    ...
    parser.add_argument("--risk", "-r", type=float, default=1.5, help="Risk per trade (%%)")
    ...
    parser.add_argument("--momentum-score", type=float, default=52.0, help="Momentum entry min score")
    parser.add_argument("--accumulation-score", type=float, default=40.0, help="Accumulation entry min score")
    parser.add_argument("--accumulation-min-oi", type=float, default=6.0, help="Accumulation entry min OI change (%%)")
