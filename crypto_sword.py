...
def main():
    ...
    parser.add_argument("--min-pullback", type=float, default=2.0, help="Min pullback (%%)")
    parser.add_argument("--reclaim-volume", type=float, default=1.15, help="5m volume reclaim ratio")
