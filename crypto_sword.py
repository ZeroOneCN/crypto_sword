...
def main():
    ...
    parser.add_argument("--stop-loss", "-s", type=float, default=6.0, help="Stop loss (%%)")
    parser.add_argument("--take-profit", "-t", type=float, default=22.0, help="Take profit (%%)")
    ...
    parser.add_argument("--momentum-score", type=float, default=72.0, help="Momentum entry min score")
    parser.add_argument("--accumulation-score", type=float, default=68.0, help="Accumulation entry min score")
    ...
    parser.add_argument("--max-chase-change", type=float, default=28.0, help="Max chase 24h change (%%)")
