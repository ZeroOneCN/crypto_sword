...
def main():
    ...
    parser.add_argument("--take-profit", "-t", type=float, default=30.0, help="Take profit (%%)")
    ...
    parser.add_argument("--min-entry-score", type=float, default=84.0, help="Minimum score for new entries")
    parser.add_argument("--defensive-entry-score", type=float, default=92.0, help="Minimum score when daily stats are weak")
    ...
    parser.add_argument("--min-change", type=float, default=2.0, help="Min 24h change (%%)")
